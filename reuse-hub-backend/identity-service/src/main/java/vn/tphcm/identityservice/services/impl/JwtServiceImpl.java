...
public class JwtServiceImpl implements JwtService {
    ...
    public void deleteToken(String token) {
        ...
        redisTemplate.delete(getRedisPrefix(token, TokenType.ACCESS_TOKEN));
        redisTemplate.delete(getRedisPrefix(token, TokenType.REFRESH_TOKEN));

        log.info("Tokens deleted successfully: {}", token);
    }
    ...
    public boolean isTokenValid(String token, TokenType type) {
        ...
        try {
            ...
            String username = extractClaim(TokenType.ACCESS_TOKEN, token, Claims::getSubject);
